...
#
# docker compose -f /home/leroy/opt_bin_resp/docker-compose.server.yaml run --rm gpu-runner python3 /app/scripts/het_casc_ng5.py
...
N_RUNS = 10
_SWEEP = list(range(5, 50))   # n_receptors values, length 45
_NS    = len(_SWEEP)
